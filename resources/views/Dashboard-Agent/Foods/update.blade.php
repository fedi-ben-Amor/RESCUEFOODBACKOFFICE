                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-9">
                                                    ...
                                                    <input type="text" name="foodName" id="foodName" value="{{$food->foodName}}"
                                                     class="form-control text-dark" placeholder="Food Name"  />
                                                     @error('foodName')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                                </div>
                                                ...
                                                <div class="form-group col-md-9">
                                                    ...
                                                    <input type="text" name="ingredients" id="ingredients" value="{{$food->ingredients}}"
                                                     class="form-control text-dark" placeholder="Separate ingredients by commas"  />
                                                    @error('ingredients')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                                </div>
                                                ...
                                                <div class="form-group col-md-9">
                                                    ...
                                                    <textarea name="description" id="description" rows="3" class="form-control text-dark" placeholder="Food Description" >{{$food->description}}
                                                ...
                                                <div class="form-group col-md-9">
                                                    ...
                                                    <input type="number" name="stockTotal" id="stockTotal" value="{{$food->stockTotal}}"
                                                     class="form-control text-dark" placeholder="Stock Total"  />
                                                     @error('stockTotal')
                                                     <span class="text-danger">{{ $message }}</span>
                                                 @enderror
                                                </div>
