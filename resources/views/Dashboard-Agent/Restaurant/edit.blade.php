                            ...
                            <div class="card-body">
                                ...
                                <form class="form-row" method="POST" action="{{ route('restaurents.update', $restaurent->id) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control" value="{{ $restaurent->name }}"  />
                                        @error('name')
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <input type="text" id="phone" name="phone" class="form-control" value="{{ $restaurent->phone }}"  />
                                        @error('phone')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <input type="text" id="cuisine_type" name="cuisine_type" class="form-control" value="{{ $restaurent->cuisine_type }}"  />
                                        @error('cuisine_type')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <input type="text" id="address" name="address" class="form-control" value="{{ $restaurent->address }}"  />
                                        @error('address')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <input type="text" id="city" name="city" class="form-control" value="{{ $restaurent->city }}"  />
                                        @error('city')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <input type="text" id="state" name="state" class="form-control" value="{{ $restaurent->state }}"  />
                                        @error('state')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                    </div>
